rule merge_taxonomy:
    input:
        gtdb="data/interim/taxon/gtdb/{taxon}/tables/df_gtdb_meta.csv",
        gtdbtk="data/processed/taxon/{taxon}/tables/gtdbtk.bac120.summary.tsv",
        # gtdbtk="data/interim/taxon/gtdbtk/{taxon}/result/classify/gtdbtk.bac120.summary.tsv",
    output:
        meta=report(
            "data/processed/taxon/{taxon}/tables/df_gtdb_meta.csv",
